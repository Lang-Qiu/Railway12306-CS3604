...
import StationInput from '../components/CS3604_12306/StationInput'
...
const HomePage: React.FC = () => {
  ...
  const [mode, setMode] = useState<Mode>(() => {
    ...
    return ['single', 'round', 'transfer', 'refund'].includes(m) ? m : 'single'
  })
  ...
  const images = useMemo(() => [
    '/images/home-carousel/carousel_bg_01.png',
    '/images/home-carousel/carousel_bg_02.png',
    '/images/home-carousel/carousel_bg_03.png',
    '/images/home-carousel/carousel_bg_04.png',
    '/images/home-carousel/carousel_bg_05.png',
    '/images/home-carousel/carousel_bg_06.png',
  ], [])
  ...
  return (
    <div className="home-page">
      ...
      <MainNavigation 
        ...
        onPersonalCenterClick={handlePersonalCenterClick}
      />
        ...
        <div className="home-content-wrapper">
          <div className="query-card">
            ...
            <button className={mode === 'single' ? 'tab active' : 'tab'} onClick={() => setMode('single')}>
              <img className="tab-icon-img" src={mode === 'single' ? '/images/home-carousel/icon_single_trip_active.png' : '/images/home-carousel/icon_single_trip_inactive.png'} alt="" aria-hidden /> 单程
            </button>
            <button className={mode === 'round' ? 'tab active' : 'tab'} onClick={() => setMode('round')}>
              <img className="tab-icon-img" src={mode === 'round' ? '/images/home-carousel/icon_round_trip_active.png' : '/images/home-carousel/icon_round_trip_inactive.png'} alt="" aria-hidden /> 往返
            </button>
            <button className={mode === 'transfer' ? 'tab active' : 'tab'} onClick={() => setMode('transfer')}>
              <img className="tab-icon-img" src={mode === 'transfer' ? '/images/home-carousel/icon_transfer_active.png' : '/images/home-carousel/icon_transfer_inactive.png'} alt="" aria-hidden /> 中转换乘
            </button>
            <button className={mode === 'refund' ? 'tab active' : 'tab'} onClick={() => setMode('refund')}>
              <img className="tab-icon-img" src={mode === 'refund' ? '/images/home-carousel/icon_refund_change_active.png' : '/images/home-carousel/icon_refund_change_inactive.png'} alt="" aria-hidden /> 退改签
            </button>
          </div>
