    ...
    <div className="train-list-top-bar">
      <div className="train-list-top-container">
        ...
        <div className="train-list-top-links">
          ...
          <a href="https://www.12306.cn/en/index.html" target="_blank" rel="noopener noreferrer" className="train-list-top-link">English</a>
          <a href="#" className="train-list-top-link" onClick={handleMy12306Click}>查看个人信息</a>
          {!isLoggedIn ? (
            <>
              <span className="train-list-welcome-text">
                <Link to="/login" className="train-list-auth-link">登录</Link>
              </span>
